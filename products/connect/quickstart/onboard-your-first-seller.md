---
description: >-
  Onboard a test seller, take a payment, and watch the split land in two
  accounts.
icon: rocket
---
...
Sign in to [<code class="expression">space.vars.dashboard_test</code>](https://gitbook.com) and click into **Connect** in the left sidebar.
{% endstep %}
...
<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h4><i class="fa-store" style="color:$primary;">:store:</i></h4></td><td><strong>Connected accounts</strong></td><td>Every seller, with their onboarding status, payout schedule, and balance.</td><td></td></tr><tr><td><h4><i class="fa-list" style="color:$primary;">:list:</i></h4></td><td><strong>Platform feed</strong></td><td>Every charge, transfer, application fee, and payout across all sellers.</td><td></td></tr></tbody></table>

## What's next

<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h4><i class="fa-toggle-on" style="color:$primary;">:toggle-on:</i></h4></td><td><strong>Switch to live mode</strong></td><td>What changes when you flip the switch.</td><td><a href="test-and-live-mode.md">test-and-live-mode.md</a></td></tr><tr><td><h4><i class="fa-window-maximize" style="color:$primary;">:window-maximize:</i></h4></td><td><strong>Add a checkout</strong></td><td>Hosted, embedded, or fully custom buyer experience.</td><td><a href="../embedded-checkout/">embedded-checkout</a></td></tr><tr><td><h4><i class="fa-percent" style="color:$primary;">:percent:</i></h4></td><td><strong>Configure splits</strong></td><td>Application fees, flat fees, and conditional rules.</td><td><a href="../platform-setup/splitting-payments.md">splitting-payments.md</a></td></tr></tbody></table>
