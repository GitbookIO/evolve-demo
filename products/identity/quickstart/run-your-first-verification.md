---
description: >-
  Run your first identity verification from the dashboard — no integration
  required.
icon: rocket
---
...
Sign in to [<code class="expression">space.vars.dashboard_test</code>](https://gitbook.com) and click into **Identity** in the left sidebar.
{% endstep %}
...
<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h4><i class="fa-toggle-on" style="color:$primary;">:toggle-on:</i></h4></td><td><strong>Switch to live mode</strong></td><td>What changes when you flip the switch.</td><td><a href="test-and-live-mode.md">test-and-live-mode.md</a></td></tr><tr><td><h4><i class="fa-list-check" style="color:$primary;">:list-check:</i></h4></td><td><strong>Pick a flow</strong></td><td>Identity, bank, business — when to use which.</td><td><a href="../verification-flows/">verification-flows</a></td></tr><tr><td><h4><i class="fa-bolt" style="color:$primary;">:bolt:</i></h4></td><td><strong>Set up a webhook</strong></td><td>React to verification results automatically.</td><td><a href="https://app.gitbook.com/s/Si95BtOt1VRLWjT7A67V/webhooks">Webhooks</a></td></tr></tbody></table>
...
<button type="button" class="button primary" data-action="ask" data-query="How do I integrate Evolve Identity with my own onboarding flow?" data-icon="code">Ask the docs</button>
{% endhint %}
