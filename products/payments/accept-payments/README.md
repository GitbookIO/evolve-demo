...
<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h4><i class="fa-circle-dollar-to-slot" style="color:$primary;">:circle-dollar-to-slot:</i></h4></td><td><strong>Take a payment</strong></td><td>The four channels for accepting money.</td><td><a href="take-a-payment.md">take-a-payment.md</a></td></tr><tr><td><h4><i class="fa-bookmark" style="color:$primary;">:bookmark:</i></h4></td><td><strong>Saved payment methods</strong></td><td>Charge the same customer again later.</td><td><a href="saved-payment-methods.md">saved-payment-methods.md</a></td></tr><tr><td><h4><i class="fa-shield-halved" style="color:$primary;">:shield-halved:</i></h4></td><td><strong>3-D Secure and SCA</strong></td><td>Liability shift and the EU rules.</td><td><a href="3d-secure.md">3d-secure.md</a></td></tr></tbody></table>

## Optimize

Once your basic flow is in production, these controls help you push the approval rate up.

<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h4><i class="fa-route" style="color:$primary;">:route:</i></h4></td><td><strong>Smart routing</strong></td><td>Pick the route most likely to approve. <em>Growth+</em></td><td><a href="smart-routing.md">smart-routing.md</a></td></tr><tr><td><h4><i class="fa-arrows-spin" style="color:$primary;">:arrows-spin:</i></h4></td><td><strong>Failover and retries</strong></td><td>Re-route around acquirer outages. <em>Enterprise</em></td><td><a href="failover.md">failover.md</a></td></tr></tbody></table>
...
* [Errors and retries](https://github.com/GitbookIO/evolve-demo/blob/main/products/payments/concepts/errors-and-retries.md) — what to do when a charge fails.
